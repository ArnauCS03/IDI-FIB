...
void MyGLWidget::viewTransform() {  // ja no cal lookAt
    glm::mat4 View(1.0f);
...
void MyGLWidget::creaBuffers() {
    ...
    glm::vec3 Vertices[4];
    Vertices[0] = glm::vec3(-2.5, 0.0, -2.5); //posterior esquerra
    Vertices[1] = glm::vec3(2.5, 0.0, -2.5);  //posterior dreta
    Vertices[2] = glm::vec3(-2.5, 0.0, 2.5);  //frontal esq
    Vertices[3] = glm::vec3(2.5, 0.0, 2.5);   //frontal dreta
